...
<div class="width1198 center_yh" style="height: 35px;background: #f0f0f0; border: 1px solid #ddd;margin-top:25px;">
    <a href="${ctx}/item/shoplist?categoryIdTwo=${obj.categoryIdTwo}&condition=${condition}" class="mR">默认</a>
    ...
    <ul class="listSs">
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <li>
                ...
                <h2 class="spName">${data.name}</h2>
                <h5 class="spName" style="color: grey">已销售：${data.gmNum} 件</h5>
