...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/resource/images/wulin1.png" alt=""></li>
            <li><img src="${ctx}/resource/images/wulin2.png" alt=""></li>
            <li><img src="${ctx}/resource/images/wulin3.png" alt=""></li>
            <li><img src="${ctx}/resource/images/wulin4.png" alt=""></li>
        </ul>
    </div>
    <script>
        $(function () {
