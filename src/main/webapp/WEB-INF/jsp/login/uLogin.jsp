...
<body>
<div class="width100 hidden_yh" style="height: 643px;background: url('${ctx}/resource/user/images/jiang1.png') no-repeat ;">
    <div class="width1200 hidden_yh center_yh" style="margin-top: 130px">
